# Makefile for Multi Engine Search Firefox Extension

# --- Variables ---

# Output filename for the packaged extension
TARGET = multi-engine-search.zip
# You can use .xpi if you prefer, Firefox accepts both for temporary loading
# TARGET = multi-engine-search.xpi

# Source files and directories to include in the package
SOURCES = manifest.json options.html popup.html css/ js/ icons/
